...
static void test_constants_have_expected_layout(void) {
...
static void test_compare_orders_lex(void) {
...
static void test_compare_first_byte_dominates(void) {
