 ...
 *
 *     q' = (value * CHRONOID_KSUID_DIV62_M) >> 64
 *     r' = value - q' * 62
 *     if (r' >= 62) { ++q'; r' -= 62; }
 *
 ...
 */
#ifndef CHRONOID_KSUID_DIVISOR_MAGIC_H
#define CHRONOID_KSUID_DIVISOR_MAGIC_H

#include <stdint.h>

#define CHRONOID_KSUID_DIV62_M_BITS 64
#define CHRONOID_KSUID_DIV62_M ((uint64_t) UINT64_C (0x421084210842108))
#define CHRONOID_KSUID_DIV62_M_2N_MINUS_M_TIMES_D 16

#endif /* CHRONOID_KSUID_DIVISOR_MAGIC_H */
